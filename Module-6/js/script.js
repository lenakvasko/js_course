...
class Hamburger {
    ...
    calculatePrice() {
        ...
        let calculateStaffings = Hamburger.STUFFINGS[this._stuffing].price;
        let priceTopings = this._toppings.reduce((acc, el) => Hamburger.TOPPINGS[el].price + acc, 0);
        return calculatePrice + calculateStaffings + priceTopings;
     ...
     */
    calculateCalories() {
        let calculatePrice = Hamburger.SIZES[this._size].calories;
        let calculateStaffings = Hamburger.STUFFINGS[this._stuffing].calories;
        let priceTopings = this._toppings.reduce((acc, el) => Hamburger.TOPPINGS[el].calories + acc, 0);
        return calculatePrice + calculateStaffings + priceTopings;
    }
  }
